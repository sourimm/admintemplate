...
export class AdminComponent implements OnInit, OnDestroy {
    ...
    public langDropdown: string;
    public langDropdownClass: string;
    ...
    constructor(public menuItems: MenuItems, private route: Router, private userService: UserService,
    ...
    ngOnInit() {
        this.name = this.userService.fullName;
        this.userService.emitFullName.subscribe((name) => {
            this.name = name;
        });

        this.avatar = this.userService.avatar;
        this.userService.emitAvatar.subscribe((avatar) => {
            this.avatar = avatar;
        });

        this.setBackgroundPattern('theme1');

        this.userService.unreadMessagesCountEmit.subscribe((unreadMessagesCount) => {
            this.unreadMessagesCount = unreadMessagesCount;
        });
        this.userService.unreadMessagesEmit.subscribe((unreadMessages) => {
            this.unreadMessages = unreadMessages;
        });

      this.notifications = this.userService.notifications;
      this.userService.emitNotifications.subscribe((name) => {
    ...
    toggleProfileNotification() {
     ...
     toggleLangDropdown() {
        this.langDropdown = this.langDropdown === 'an-off' ? 'an-animate' : 'an-off';
        this.langDropdownClass = this.langDropdown === 'an-animate' ? 'show' : '';
    }
