...
@Component({
  selector: 'app-more-from-us-section3',
  templateUrl: './more-from-us-section3.component.html',
  styleUrls: ['./more-from-us-section3.component.scss']
})
export class MoreFromUsSection3Component implements OnInit, OnChanges {
