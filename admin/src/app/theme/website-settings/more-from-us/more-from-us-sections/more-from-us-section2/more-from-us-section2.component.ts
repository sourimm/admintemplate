...
@Component({
  selector: 'app-more-from-us-section2',
  templateUrl: './more-from-us-section2.component.html',
  styleUrls: ['./more-from-us-section2.component.scss']
})
export class MoreFromUsSection2Component implements OnInit, OnChanges {
