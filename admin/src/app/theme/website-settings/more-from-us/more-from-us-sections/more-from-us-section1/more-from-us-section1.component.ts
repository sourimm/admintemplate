...
@Component({
  selector: 'app-more-from-us-section1',
  templateUrl: './more-from-us-section1.component.html',
  styleUrls: ['./more-from-us-section1.component.scss']
})
export class MoreFromUsSection1Component implements OnInit, OnChanges {
