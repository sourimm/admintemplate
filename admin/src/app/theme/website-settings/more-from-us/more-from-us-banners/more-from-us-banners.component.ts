...
@Component({
  selector: 'app-more-from-us-banners',
  templateUrl: './more-from-us-banners.component.html',
  styleUrls: ['./more-from-us-banners.component.scss']
})
export class MoreFromUsBannersComponent implements OnInit {
