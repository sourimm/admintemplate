...
@Component({
  selector: 'app-what-we-do-section3',
  templateUrl: './what-we-do-section3.component.html',
  styleUrls: ['./what-we-do-section3.component.scss']
})
export class WhatWeDoSection3Component implements OnInit {
