...
@Component({
  selector: 'app-what-we-do-section2',
  templateUrl: './what-we-do-section2.component.html',
  styleUrls: ['./what-we-do-section2.component.scss']
})
export class WhatWeDoSection2Component implements OnInit {
